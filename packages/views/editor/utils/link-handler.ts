...
import { isGlobalPath } from "@ohmyagentteam/core/paths";
...
/**
 * Open a link — internal paths dispatch ohmyagentteam:navigate, external open new tab.
 *
...
export function openLink(href: string, currentSlug?: string | null): void {
  if (href.startsWith("/")) {
    ...
    window.dispatchEvent(
      new CustomEvent("ohmyagentteam:navigate", { detail: { path } }),
    );
  } else {
