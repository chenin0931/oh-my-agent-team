...
const longRepoUrl =
  "https://github.com/chenin0931/a-very-long-repository-name-that-needs-a-tooltip";
const apiRepoUrl = "https://github.com/chenin0931/api";
const webRepoUrl = "https://github.com/chenin0931/web";

vi.mock("@tanstack/react-query", () => ({
  useQuery: () => ({ data: [] }),
}));

vi.mock("@ohmyagentteam/core/projects/mutations", () => ({
  useCreateProject: () => ({ mutateAsync: vi.fn() }),
}));

vi.mock("@ohmyagentteam/core/projects", () => ({
...
vi.mock("@ohmyagentteam/ui/components/ui/popover", () => ({
...
vi.mock("@ohmyagentteam/ui/components/common/emoji-picker", () => ({
  EmojiPicker: () => null,
}));
