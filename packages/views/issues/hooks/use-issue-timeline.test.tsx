...
// Mock @ohmyagentteam/core/issues/mutations to mimic TanStack Query v5's contract:
...
describe("useIssueTimeline", () => {
  ...
  // ohmyagentteam#1968). The memo only pays off if the callbacks passed down keep
