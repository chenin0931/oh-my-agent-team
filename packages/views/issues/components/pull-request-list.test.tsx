...
import type { GitHubPullRequest } from "@ohmyagentteam/core/types";
import enCommon from "../../locales/en/common.json";
import enIssues from "../../locales/en/issues.json";

const TEST_RESOURCES = { en: { common: enCommon, issues: enIssues } };

vi.mock("@ohmyagentteam/core/github/queries", async () => {
  const actual = await vi.importActual<typeof import("@ohmyagentteam/core/github/queries")>(
    "@ohmyagentteam/core/github/queries",
  );
  return {
    ...actual,
