...
vi.mock("@ohmyagentteam/core/issues/mutations", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@ohmyagentteam/core/issues/mutations")>();
  return {
    ...actual,
...
describe("SwimLaneView", () => {
  ...
  it("groups by project when swimlaneGrouping is 'project'", () => {
    ...
    expect(
      screen.getAllByText("Unassigned to project").length,
