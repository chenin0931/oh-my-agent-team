...
vi.mock("@ohmyagentteam/core/github", async () => {
  const actual =
    await vi.importActual<typeof import("@ohmyagentteam/core/github")>("@ohmyagentteam/core/github");
  return {
    ...actual,
...
describe("GitHubTab", () => {
  ...
  it("clicking Disconnect opens the confirmation and only fires on confirm", async () => {
    ...
    expect(
      screen.getByText(/OhMyAgentTeam will stop receiving webhooks/i),
    ).toBeTruthy();
