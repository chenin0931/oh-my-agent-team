...
/**
 * Server-side fetcher for the latest OhMyAgentTeam release, designed to
...
const GITHUB_RELEASES_URL =
  "https://api.github.com/repos/chenin0931/oh-my-agent-team/releases?per_page=2";
...
export async function fetchLatestRelease(): Promise<LatestRelease> {
  ...
  try {
    ...
    // Defensive filter — OhMyAgentTeam doesn't publish prereleases or drafts
