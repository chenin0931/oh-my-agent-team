...
const SAMPLE_LATEST_ASSET = {
  name: "ohmyagentteam-desktop-0.2.14-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/chenin0931/oh-my-agent-team/releases/download/v0.2.14/ohmyagentteam-desktop-0.2.14-mac-arm64.dmg",
};

const SAMPLE_PREV_ASSET = {
  name: "ohmyagentteam-desktop-0.2.13-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/chenin0931/oh-my-agent-team/releases/download/v0.2.13/ohmyagentteam-desktop-0.2.13-mac-arm64.dmg",
};
...
function releasePayload(overrides: {
  ...
  return {
    ...
    html_url: `https://github.com/chenin0931/oh-my-agent-team/releases/tag/${overrides.tag}`,
