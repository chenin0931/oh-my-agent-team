 ...
 *   ohmyagentteam-desktop-{version}-mac-{arch}.{dmg|zip}
 *   ohmyagentteam-desktop-{version}-windows-{arch}.exe
 *   ohmyagentteam-desktop-{version}-linux-{arch}.{AppImage|deb|rpm}
 *
...
const DESKTOP_ARTIFACT_RE =
  /^ohmyagentteam-desktop-[^-]+-(mac|windows|linux)-([a-z0-9_]+)\.(dmg|zip|exe|AppImage|deb|rpm)$/i;
