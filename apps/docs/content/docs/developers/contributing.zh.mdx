---
title: Contributing
description: Local development workflow for contributors working on the OhMyAgentTeam codebase.
---
...
| | Main | Worktree |
|---|---|---|
| Database | `ohmyagentteam` | `omat_my_feature_702` |
...
```bash
docker compose exec -T postgres psql -U ohmyagentteam -d postgres \
