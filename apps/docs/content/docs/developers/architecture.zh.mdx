---
title: Architecture
description: Technical architecture of the OhMyAgentTeam platform.
---

## Overview

OhMyAgentTeam is a Go backend + monorepo frontend (pnpm workspaces + Turborepo) with shared packages.
...
- **Entry points** (`cmd/`): `server` (HTTP API), `ohmyagentteam` (CLI + daemon), `migrate`
