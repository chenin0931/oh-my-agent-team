...
description: Get started with OhMyAgentTeam Cloud — no setup required.
---

The fastest way to get started with OhMyAgentTeam — no setup required.

## 1. Sign up

Go to [ohmyagentteam.com](https://ohmyagentteam.com) and create an account.
