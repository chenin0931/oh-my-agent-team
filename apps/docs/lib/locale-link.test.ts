...
describe("prefixLocale", () => {
  ...
  it("leaves external URLs alone", () => {
    expect(prefixLocale("https://ohmyagentteam.com/download", "zh")).toBe(
      "https://ohmyagentteam.com/download",
    );
    expect(prefixLocale("mailto:hello@ohmyagentteam.com", "zh")).toBe(
      "mailto:hello@ohmyagentteam.com",
    );
