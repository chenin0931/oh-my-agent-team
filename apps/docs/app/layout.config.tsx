...
// Docs-local stateless OhMyAgentTeam mark — matches @ohmyagentteam/ui's OhMyAgentTeamIcon
...
// packages/ui/components/common/ohmyagentteam-icon.tsx if the mark changes.
const OMAT_CLIP = `polygon(
...
// desktop). Leading icon = brand identity (GitHub mark / OhMyAgentTeam asterisk);
...
export const baseOptions: BaseLayoutProps = {
  nav: {
    title: (
      <span className="font-semibold text-base">OhMyAgentTeam Docs</span>
    ),
  },
  links: [
    {
    ...
    {
      icon: <OhMyAgentTeamMark />,
      text: externalLinkText("OhMyAgentTeam"),
      url: "https://ohmyagentteam.com",
      external: true,
    },
  ],
};
