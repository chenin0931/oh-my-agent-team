/**
 * OhMyAgentTeam architecture diagram for §1.2 "How OhMyAgentTeam Works".
 *
 ...
 * "OhMyAgentTeam" (metadata store and coordinator).  The asymmetric sizes and the
 * brand-tinted left panel visually argue OhMyAgentTeam's core thesis: AI runs on
      ...
      <div className="flex-1 space-y-5">
        ...
        <div>
          ...
          <div className="text-xs text-muted-foreground mb-2.5">
            Polls work from OhMyAgentTeam. Invokes local AI coding tools:
          </div>
