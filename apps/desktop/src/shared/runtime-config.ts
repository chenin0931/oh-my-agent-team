...
// Convention: api hosts are exposed at `api.<web-host>` (api.ohmyagentteam.com →
// ohmyagentteam.com, api.test.ohmyagentteam.com → test.ohmyagentteam.com). Strip the leading
