...
describe("isSafeExternalHttpUrl", () => {
  it("allows http and https URLs", () => {
    expect(isSafeExternalHttpUrl("https://ohmyagentteam.com")).toBe(true);
...
describe("openExternalSafely", () => {
  ...
  it("forwards http/https URLs to shell.openExternal", () => {
    openExternalSafely("https://ohmyagentteam.com");
    expect(shell.openExternal).toHaveBeenCalledWith("https://ohmyagentteam.com");
  });
