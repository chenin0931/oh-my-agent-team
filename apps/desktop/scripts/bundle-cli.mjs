#!/usr/bin/env node
// Builds the `ohmyagentteam` CLI from server/cmd/omat and copies the binary
...
//
// ldflags mirror `make build` so `ohmyagentteam --version` reports a meaningful
// version / commit / date.
//
...
function binaryNameForPlatform(platform) {
  return platform === "win32" ? "omat.exe" : "ohmyagentteam";
}
