...
not a OhMyAgentTeam problem.

### Concrete library survey (2026-05)

| Library | Path | Last release | Verdict for OhMyAgentTeam |
|---|---|---|---|
...
OhMyAgentTeam mobile uses a **segment-based hybrid renderer** that dispatches
