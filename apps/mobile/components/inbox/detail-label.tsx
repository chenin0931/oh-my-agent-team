...
const TYPE_LABEL: Record<InboxItemType, string> = {
  ...
  session_approval: "Approval needed",
  session_waiting_input: "Input needed",
  session_waiting_environment: "Execution computer needed",
  outcome_failed: "Outcome needs a decision",
