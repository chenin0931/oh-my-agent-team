...
const DB = process.env.DATABASE_URL || "postgres://ohmyagentteam:ohmyagentteam@localhost:5432/omat_omat_101?sslmode=disable";
...
async function main() {
  ...
  await page.evaluate((t) => localStorage.setItem("omat_token", t), token);
