...
OMAT_APP_URL="${OMAT_APP_URL:-${FRONTEND_ORIGIN}}"
GOOGLE_REDIRECT_URI="${GOOGLE_REDIRECT_URI:-${FRONTEND_ORIGIN}/auth/callback}"
OMAT_SERVER_URL="${OMAT_SERVER_URL:-ws://localhost:${PORT}/ws}"
...
export OMAT_APP_URL GOOGLE_REDIRECT_URI OMAT_SERVER_URL LOCAL_UPLOAD_BASE_URL
