...
- `server/cmd/omat/cmd_project.go` registers project `list`, `get`, `create`, `update`, `delete`, and `status`.
...
- Project resources are written into `.ohmyagentteam/project/resources.json` for agent workdirs.
