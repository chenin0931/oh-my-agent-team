...
This file records source evidence for `ohmyagentteam-squads/SKILL.md`.
...
```bash
omat squad list
omat squad get <squad-id>
omat squad create
omat squad update <squad-id>
omat squad delete <squad-id>
omat squad activity <issue-id> <outcome>

omat squad member list <squad-id>
omat squad member add <squad-id>
omat squad member remove <squad-id>
...
- agent member roster rows list assigned workspace skills via
  ...
  "no skills assigned"; builtin ohmyagentteam-* skills are excluded and human
