...
// (OhMyAgentTeam Cloud Node) PAT. Tokens with this prefix are validated by
// calling the OhMyAgentTeam Cloud Fleet service rather than by hitting our
...
// OMAT_CLOUD_FLEET_URL configured simply rejects mcn_ tokens at
...
type CloudPATVerifierConfig struct {
	...
	// https://fleet.ohmyagentteam.cloud). Trailing slashes are trimmed.
