...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.ohmyagentteam.com"
	cookieDomain string // cookie scope, e.g. ".ohmyagentteam.com"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.ohmyagentteam.com")
//   - COOKIE_DOMAIN           (e.g. ".ohmyagentteam.com")
