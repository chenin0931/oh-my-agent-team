...
func TestAuth_ValidToken(t *testing.T) {
	...
	if gotEmail != "test@ohmyagentteam.com" {
		t.Fatalf("expected X-User-Email 'test@ohmyagentteam.com', got '%s'", gotEmail)
	}
}
...
// as the daemon side: with no OMAT_CLOUD_FLEET_URL configured, an
