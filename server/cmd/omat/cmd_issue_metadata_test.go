...
// Tests for `omat issue metadata list` 404-degradation behavior, plus
...
// endpoint working.
//
// Background: GitHub issue chenin0931/oh-my-agent-team#3711 — on self-hosted
// backends that pre-date the per-issue metadata route, agent runtime
// bootstrap calls `omat issue metadata list <issue> --output json`
