...
var rootHelpTemplate = `Work with OhMyAgentTeam from the command line.
...
EXAMPLES
  $ {{.CommandPath}} login
  $ {{.CommandPath}} issue list --output json
  $ {{.CommandPath}} daemon start
  $ {{.CommandPath}} agent list --output json

ENVIRONMENT VARIABLES
  OMAT_SERVER_URL    Override the default server URL
  OMAT_WORKSPACE_ID  Set the active workspace
