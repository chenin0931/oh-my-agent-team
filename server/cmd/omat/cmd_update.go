...
var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update the OhMyAgentTeam CLI",
	RunE:  runUpdate,
}
...
func runUpdate(_ *cobra.Command, _ []string) error {
	...
	if cli.IsBrewInstall() {
		...
		if err != nil {
			...
			return fmt.Errorf("brew upgrade failed: %w\nYou can try manually: brew upgrade chenin0931/tap/ohmyagentteam", err)
		}
	...
	if latest == nil {
		return fmt.Errorf("could not determine latest version; check https://github.com/chenin0931/oh-my-agent-team/releases/latest")
	}
