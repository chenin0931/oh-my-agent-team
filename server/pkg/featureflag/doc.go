...
// Wiring:
//
// The standard way to construct the Service inside the ohmyagentteam server is
// featureflag.NewServiceFromEnv, which reads OMAT_FEATURE_FLAGS_FILE for
