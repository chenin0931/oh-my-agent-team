...
func TestOpencodeEventParsingToolUseFixture(t *testing.T) {
	...
	line := `{"type":"tool_use","timestamp":1775117187163,"sessionID":"ses_abc","part":{"id":"prt_123","messageID":"msg_456","sessionID":"ses_abc","type":"tool","tool":"bash","callID":"call_BHA1","state":{"status":"completed","input":{"command":"pwd","description":"Prints current working directory path"},"output":"/tmp/omat\n","metadata":{"exit":0},"time":{"start":1775117187092,"end":1775117187162}}}}`
	...
	if output, ok := event.Part.State.Output.(string); !ok || output != "/tmp/omat\n" {
...
func TestResolveOpenCodeNativeFromShimResolvesNpmShim(t *testing.T) {
	...
	// Reporter's exact layout from ohmyagentteam#1717.
